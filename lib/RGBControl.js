...
class RGBControl
{
    constructor(app)
    {
        ...
        this.queue.process((job, done) => {
            this.processJob(job.data.type, job.data, job, done);
        });
    ...
    newJob(type, ops, options)
    {
        this.queue.add(Object.assign({}, { type: type }, (ops || {})), (options || {}));
    }
